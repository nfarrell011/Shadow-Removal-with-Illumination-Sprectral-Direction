...
from new_process_image_class_combined import LogChromaticity
...
class AnnotationManager:
    ...
    def set_directories(self, processed_folder, image_error_folder, bad_image_folder) -> None:
        """
    ...
    def isd_method(self, val) -> None:
        ...
        """
        if self.img_processor is not None:
            self.processed_img = self.img_processor.set_isd_method(val)
            self.display_images()
