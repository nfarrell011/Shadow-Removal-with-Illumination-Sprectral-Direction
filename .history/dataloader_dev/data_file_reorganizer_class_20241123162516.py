    ...
    def reorganize_data_files(path_to_parent_data_folder:str, images_folder_list:list, image_quality_list:list) -> None:
        ...
        for img_folder in images_folder_list:
            ...
            for image_quality in image_quality_list:
                    ...
                    # Set folder paths
                    image_folder = project_root_folder / path_to_parent_data_folder / img_folder / f"processed" / image_quality
                    isd_map_folder = project_root_folder / path_to_parent_data_folder / img_folder / f"processed" / "isd_maps"
