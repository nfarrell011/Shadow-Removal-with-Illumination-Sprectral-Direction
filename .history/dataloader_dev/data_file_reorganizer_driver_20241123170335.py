...
def main():
    ...
    # Params Step # 3
    folder_name_training_images = "training_images"
    output_folder_cropped_training_images = "training_images_cropped"
    
    folder_name_training_isds = "training_isds"
    output_folder_cropped_isds_images = "training_isds_cropped"
    crop_size = 448
    sub_crop_size = 224
    ...
    # Step 4
    if crop_images:
        dfr.center_crop_and_split(folder_name, output_folder, crop_size, sub_crop_size)
